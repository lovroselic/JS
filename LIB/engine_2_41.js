...
var GRID = {
  ...
  findPathToFirstCrossroad: function (
    ...
    //corrected?
    let path = GRID.findPath(start, finish, dungeon, ENGINE.INI.MAX_PATH, firstDir);
  ...
  AI: {
    ...
    shadower: {
      hunt: function (entity, MS, tolerance) {
        let solutions = MS.endGrid.directionSolutions(entity.MoveState.homeGrid);
